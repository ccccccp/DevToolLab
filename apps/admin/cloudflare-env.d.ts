/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: b3dc268160ffddbba7100f69f3132258)
// Runtime types generated with workerd@1.20260421.1 2026-04-28 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		WORKER_SELF_REFERENCE: Fetcher /* devtoollab-admin */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEVTOOLLAB_API_BASE_URL" | "DEVTOOLLAB_WORKER_API_SECRET" | "ADMIN_SESSION_SECRET">> {}
}
